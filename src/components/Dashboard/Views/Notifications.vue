    ...
    <div class="container-fluid">
      <div class="card">
        <div class="header">
          ...
          <p class="category">Handcrafted by our friend <a target="_blank" href="https://github.com/cristijora">Cristi Jora</a>. Please checkout the <a href="https://github.com/cristijora/vue-notifyjs" target="_blank">full documentation.</a></p>
